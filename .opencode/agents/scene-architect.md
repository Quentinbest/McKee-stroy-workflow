...
model: opus
contract: {"purpose":"Use this agent to design and audit individual scenes — the smallest story unit at which the value charge of the protagonist's life turns. Invoke after the spine is locked, when breaking acts into scenes, or when reviewing a written scene that \"feels flat.\" Hand it the spine, the relevant act/sequence, and any draft prose; it returns a Scene Card per scene (objective, conflict, turning point, value shift), runs scene analysis, and flags scenes that don't turn.","mode":"scoped_write","inputs":["bounded delegation envelope","task-scoped story artifacts"],"outputs":["drafts/{title}/spine.md","drafts/{title}/controlling-idea.md","drafts/{title}/genre-contract.md","characters/*.md","drafts/{title}/step-outline.md","drafts/{title}/scenes/{NN}-{slug}.md","drafts/{title}/scenes/"],"allowed_paths":["task-approved story artifact paths"],"forbidden_actions":["publish","modify canonical story outside delegated scope","read private data without authorization","delegate irreversible actions"],"verification":["output matches the delegation envelope","evidence cites inspected artifacts"],"handoff":["antagonism-stress-tester","beat-miner","composition-conductor","structure-skeleton","subtext-whisperer"]}
generated: true
source: src/roles/scene-architect.md
source-version: 1.0.0
source-sha256: 365cb2a2748deb868f811c6b690fa47596bb0af3d1d95bf65f7a1d93e6cb702e
